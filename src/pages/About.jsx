...
export default function AboutUs() {
  return (
    <div className="relative w-full min-h-screen overflow-hidden text-[#1C1917] bg-[#F0F7FF] selection:bg-[#1660C1]/30 font-sans">

      {/* ================= GLOBAL BACKGROUND FX ================= */}
      <div className="fixed inset-0 z-0 pointer-events-none">
        {/* Dynamic Aurora-like Gradients */}
        <div className="absolute top-[-20%] left-[-10%] w-[600px] h-[600px] bg-[#1660C1]/10 rounded-full blur-[120px] animate-[pulse_8s_ease-in-out_infinite]" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] bg-[#5BA9E1]/8 rounded-full blur-[100px] animate-[pulse_6s_ease-in-out_infinite_reverse]" />
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden z-10 pt-20">
        ...
        <div className="absolute inset-0 z-0 select-none">
          <div className="absolute inset-0 bg-gradient-to-b from-[#F0F7FF]/40 via-transparent to-[#F0F7FF] z-20" />
          <img
            src={heroImage}
        ...
        <div className="relative z-30 max-w-7xl mx-auto px-6 text-center">
          <FadeIn>
            <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full bg-[#1660C1]/10 border border-[#1660C1]/20 backdrop-blur-md text-[#1660C1] text-sm font-bold tracking-wide uppercase hover:bg-[#1660C1]/20 transition-colors cursor-default">
          ...
          <FadeIn delay={200}>
            <h1 className="mt-8 text-6xl md:text-8xl lg:text-9xl font-extrabold tracking-tighter leading-[0.9]">
              Reimagining <br />
              <span className="font-black text-transparent bg-clip-text bg-gradient-to-r from-[#1660C1] via-[#C7DFF7] to-[#1660C1] bg-[length:200%_auto] animate-[shimmer_5s_linear_infinite]">
                Trust & Trade
              </span>
            </h1>
          </FadeIn>
          ...
          <FadeIn delay={400}>
            <p className="mt-10 text-lg md:text-2xl text-[#1C1917]/60 max-w-2xl mx-auto font-light leading-relaxed">
              Where <span className="text-[#1660C1] font-bold">BSE's legacy</span> meets the future of agriculture.<br />
      ...
      {/* ================= STATS / IMPACT STRIP ================= */}
      <section className="relative z-20 border-y border-[#1660C1]/10 bg-[#E8F2FC]/50 backdrop-blur-sm overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 divide-x divide-[#1660C1]/10">
          {[
            ...
            <div key={i} className="py-12 text-center group hover:bg-[#1660C1]/5 transition-colors duration-500">
              <h3 className="text-4xl md:text-5xl font-extrabold text-[#1C1917] mb-2 group-hover:scale-110 transition-transform duration-300">
                {stat.value}<span className="text-[#1660C1] text-2xl">{stat.suffix}</span>
              </h3>
      ...
      {/* ================= NARRATIVE SPLIT ================= */}
      <section className="relative py-40 z-10 bg-[#F0F7FF]">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid lg:grid-cols-2 gap-20">
          ...
          <FadeIn className="relative">
            ...
            <h2 className="text-5xl font-extrabold mb-8 leading-tight text-[#1C1917]">
              Transforming India's<br /> <span className="text-[#1660C1]">Agri & Commodity Ecosystem</span>
            </h2>
...
The company is engaged in facilitating agri-commodity trading, connecting stakeholders across the agricultural ecosystem, and offering innovative financial solutions to enhance market access, operational efficiency, and value creation. BEAM partners with government departments, corporations, farmers, Farmer Producer Organizations (FPOs), traders, and industry associations to offer comprehensive supply chain solutions
          ...
          <FadeIn delay={200} className="relative group">
            <div className="absolute inset-0 bg-[#1660C1] rounded-3xl blur opacity-10 group-hover:opacity-20 transition-opacity duration-700" />
            <div className="relative h-full bg-[#E8F2FC]/50 border border-[#1660C1]/10 rounded-3xl p-10 flex flex-col justify-center overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12">
          ...
          <FadeIn className="group relative">
            <div className="absolute -inset-1 bg-gradient-to-r from-theme-highlight to-theme-accent rounded-[2.5rem] opacity-20 blur transition duration-500 group-hover:opacity-50" />
              <div className="relative h-full bg-[#E8F2FC] rounded-[2.5rem] p-12 border border-[#1660C1]/10 hover:border-[#1660C1]/30 transition-colors duration-500">
          ...
          <FadeIn delay={200} className="group relative">
            <div className="absolute -inset-1 bg-gradient-to-r from-[#1660C1] to-[#5BA9E1] rounded-[2.5rem] opacity-20 blur transition duration-500 group-hover:opacity-50" />
            <div className="relative h-full bg-[#E8F2FC] rounded-[2.5rem] p-12 border border-white/5 hover:border-[#1660C1]/30 transition-colors duration-500">
              <div className="w-16 h-16 bg-[#1660C1]/10 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-500">
                <svg className="w-8 h-8 text-[#1660C1]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
              </div>
      ...
      {/* ================= REASONS GRID ================= */}
      <section className="relative py-32 bg-white text-[#0A246A] rounded-t-[5rem] overflow-hidden -mt-16 z-20">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-20 animate-on-scroll">
            <h2 className="text-5xl font-bold mb-6 tracking-tight">Why Choose<span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1660C1] to-[#5BA9E1]"> BeAM?</span></h2>
          ...
          <div className="space-y-8">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              {features.slice(0, 4).map((feature, idx) => (
                <div key={idx} className="group p-10 bg-gray-50 rounded-[2rem] border border-transparent hover:border-[#1660C1]/30 hover:bg-white hover:shadow-2xl hover:shadow-[#0A246A]/5 transition-all duration-500">
                  <div className="w-14 h-14 bg-white border border-gray-100 rounded-2xl flex items-center justify-center text-[#0A246A] mb-6 group-hover:bg-[#1660C1] group-hover:text-white transition-colors duration-500 shadow-sm">
                    {feature.icon}
                  </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {features.slice(4, 7).map((feature, idx) => (
                <div key={idx + 4} className="group p-10 bg-gray-50 rounded-[2rem] border border-transparent hover:border-[#1660C1]/30 hover:bg-white hover:shadow-2xl hover:shadow-[#0A246A]/5 transition-all duration-500">
                  <div className="w-14 h-14 bg-white border border-gray-100 rounded-2xl flex items-center justify-center text-[#0A246A] mb-6 group-hover:bg-[#1660C1] group-hover:text-white transition-colors duration-500 shadow-sm">
                    {feature.icon}
                  </div>
                  <h3 className="text-2xl font-bold mb-4 text-gray-900 group-hover:translate-x-1 transition-transform">{feature.title}</h3>
      ...
      <div className="bg-white py-32">
        <div className="max-w-7xl mx-auto px-6">
          <div className="rounded-[3rem] bg-[#0A246A] p-16 md:p-32 relative overflow-hidden">
            {/* Hover Reveal Glow */}
            <div className="absolute inset-0 bg-gradient-to-r from-[#1660C1]/20 to-transparent opacity-30 transition-opacity duration-1000 pointer-events-none" />
              ...
              {[
                ...
                <div key={i} className="flex flex-col items-center text-center group">
                  <div className="relative w-40 h-40 mb-12">
                    ...
                    <div className="relative w-full h-full rounded-3xl overflow-hidden shadow-2xl shadow-[#1660C1]/20 group-hover:shadow-3xl group-hover:shadow-[#1660C1]/40 transition-all duration-700 transform group-hover:-translate-y-2 group-hover:scale-105">
                      {/* Image */}
                      <img 
                        src={item.image} 
                        alt={item.title} 
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-[#1660C1]/20 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
