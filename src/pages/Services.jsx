...
const Services = () => {
  ...
  return (
    <>
        ...
        <div className="relative max-w-7xl mx-auto px-12 grid lg:grid-cols-2 gap-24 items-center">
          ...
          >
            ...
            <motion.p
              ...
              className="mt-12 max-w-xl text-lg text-[#1C1917]/90 leading-relaxed"
            >
      ...
      <section id="public-sector" className="relative pt-40 pb-40 px-24 bg-gradient-to-br from-[#DAEAF8] via-[#C8DFF5] to-[#DCECFA] text-[#1C1917] scroll-mt-24 ">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="relative">
              ...
              <p className="mt-10 text-lg leading-relaxed text-[#1C1917]/75 max-w-xl">
                ...
                {[
                  ...
                  <div
                    ...
                    className="group relative p-6
                         ...
                         border border-[#1660C1]/15 rounded-2xl
                         clip-path-[polygon(0_0,95%_0,100%_50%,95%_100%,0_100%)]
                         hover:border-[#3A7BD5]/60
                         shadow-[0_8px_32px_rgba(22,96,193,0.12)]
                         transition-all"
                  >
      ...
      <section id="trade-connect" className="relative bg-cloud-white-soft py-32 text-hill-green-deep scroll-mt-24 ">
    ...
    bg-[size:96px_96px]" />
      ...
      <section id="data-analytics-and-consulting" className="relative pt-40 pb-40 px-24 bg-gradient-to-tl from-[#DCECFA] via-[#CDE3F5] to-[#DAEAF8] text-[#1C1917] scroll-mt-24">
      ...
      <section id="financial-float-trade" className="relative bg-cloud-white-soft py-40  text-hill-green-deep scroll-mt-24">
    ...
    bg-[size:96px_96px]" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-28">
          ...
          <div className="relative">
            ...
            {/* accent bar */}
            <div className="absolute -left-10 top-6 w-1 h-24 bg-black" />

            <h2 className="text-6xl text-black font-extrabold leading-tight">
              Trade{" "}
              <span className="text-[#1E8E6E]">
                Finance
              </span>
      ...
      <section id="metals" className="relative pt-40 pb-40 px-24 bg-gradient-to-br from-[#DAEAF8] via-[#C8DFF5] to-[#DCECFA] text-[#1C1917] scroll-mt-24">
      ...
      <section id="bioenergy" className="relative bg-white py-32 scroll-mt-24 ">
        ...
        <div className="relative max-w-7xl mx-auto px-10 grid grid-cols-1 lg:grid-cols-12 gap-20">
          ...
          <div className="lg:col-span-5">
            <div className="sticky top-32 rounded-[28px] bg-gradient-to-br from-[#1660C1] to-[#0D3A8C] shadow-[0_30px_80px_rgba(0,0,0,0.25)]">
          ...
          <details className="group rounded-2xl border border-theme-highlight/20 bg-theme-highlight/5">
            ...
            <div className="px-6 pb-6 sm:px-8 sm:pb-8">
              ...
              <div className="mt-6 flex justify-start">
                <a
                  href="#download"
                  className="inline-flex items-center gap-3 rounded-xl bg-gradient-to-r from-theme-highlight to-theme-accent px-5 py-3 text-sm font-semibold text-[#1C1917] shadow-lg hover:opacity-95 transition-opacity"
                >
                  <svg className="w-5 h-5 text-[#1C1917]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
